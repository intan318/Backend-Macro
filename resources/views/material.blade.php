  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            <li class="active"><a href="index.html"><i class="fa fa-dashboard"></i> Material</a></li>
            <li><a href="charts.html"><i class="fa fa-bar-chart-o"></i> Add Material</a></li>
      ...
      <div id="page-wrapper">
        ...
        {{-- <div class="row">
          <div class="col-lg-12">
            <h1>Material <small>Statistics Overview</small></h1>
            <ol class="breadcrumb">
              <li class="active"><i class="fa fa-dashboard"></i> Material </li>
            </ol>
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    <p class="announcement-heading">45</p>
                    <p class="announcement-text">Materials</p>
                  </div>
                </div>
              </div>
              <a href="#">
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text">Cities</p>
                  </div>
                </div>
              </div>
              <a href="#">
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text">Projects</p>
                  </div>
                </div>
              </div>
              <a href="#">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-money"></i> Materials </h3>
              </div>
              <div class="panel-body">
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    <thead>
                      <tr>
                        ...
                        <th>Material Code <i class="fa fa-sort"></i></th>
                        <th>Material Name <i class="fa fa-sort"></i></th>
                        <th>Material Brand <i class="fa fa-sort"></i></th>
                        <th>Material Grade <i class="fa fa-sort"></i></th>
                        <th>Material Size <i class="fa fa-sort"></i></th>
                        <th>Material Unit <i class="fa fa-sort"></i></th>
                        <th>Seller ID <i class="fa fa-sort"></i></th>
    ...
    <table class="table table-bordered table-striped table-light">
      <thead>
        <tr>
          ...
          <th scope="col">Material Brand</th>
          <th scope="col">Material Size</th>
      ...
      <tbody>
        ...
        <tr>
          <th> {{ $materialdata->id }}</th>
          <td> {{ $materialdata->matcode }}</td>
          <td> {{ $materialdata->matname }}</td>
          <td> {{ $materialdata->matbrand }}</td>
          <td> {{ $materialdata->matsize }}</td>
          <td> {{ $materialdata->matunit }}</td>
          <td> {{ $materialdata->sellerid }}</td>
          <td> {{ $materialdata->categoryid }}</td>
